...
function HomeScreen({
  ...
  const progress = useMemo(() => Math.round((goal.saved / goal.target) * 100), [goal]);
  ...
  const saveNow = () => {
    ...
    setGoals((prev) =>
      prev.map((g) =>
        g.id === goal.id ? { ...g, saved: Math.min(g.saved + 200, g.target) } : g
      )
    );
  };
  ...
  return (
    <div className="screen">
      ...
      <div className="card big-cta enter delay-2">
        ...
        <button className={cx("cta-btn", dailySaved && "cta-done")} onClick={saveNow}>
          {dailySaved ? "Saved ✓" : "Save Now"}
        </button>

        <div className="mini-pulse">
          <div className="mini-pulse-dot" />
          <span>{dailySaved ? "Momentum locked" : "Tap to trigger reward"}</span>
        </div>
      </div>
      ...
      <div className="card goal-card enter delay-4" onClick={() => setActiveGoalId(goal.id)}>
      ...
      <div className="goal-strip enter delay-10">
        {goals.slice(0, 2).map((g) => {
          ...
          return (
            <div
              className={cx("mini-goal", g.id === goal.id && "mini-goal-active")}
              key={g.id}
  ...
  return (
    <div className="screen">
      ...
      <div className="card deep-card enter delay-4">
        ...
        <div className="projection-grid">
          ...
          <div className="projection-row">
            <span>5y</span>
            <div className="projection-bar">
              <div className="projection-fill projection-fill-green" style={{ width: "82%" }} />
            </div>
            <strong>₹8L</strong>
          </div>
          <div className="projection-row">
            <span>10y</span>
            <div className="projection-bar">
              <div className="projection-fill projection-fill-purple" style={{ width: "93%" }} />
            </div>
            <strong>₹22L</strong>
          </div>
        </div>
        ...
        {missions.map((m) => (
          <div className="card mission-card" key={m.title}>
            ...
            <div className="mission-track">
              <div className="mission-fill" style={{ width: `${m.progress}%` }} />
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="card insight-card enter delay-6">
        ...
        <div className="insight-sub">That becomes roughly ₹15K/year if you fix the leak.</div>
      </div>
      ...
      <div className="card p2p-card enter delay-7">
        ...
        <div className="p2p-sub">Future module. Squad lending, controlled risk, real returns.</div>
            ...
            >
              <div className="goal-top">
                ...
                <div className="goal-copy">
                  ...
                  <div className="goal-note">{g.pool ? "Squad pool" : "Personal target"}</div>
                </div>
...
function ProfileScreen({ xp, balance }) {
  return (
    <div className="screen">
      ...
      <div className="page-sub enter delay-1">Identity, status, and control.</div>
...
function CreateGoalOverlay({ onClose, onAdd }) {
  ...
  return (
    <>
      <div className={cx("backdrop", closing ? "fade-out" : "fade-in")} onClick={close} />
      <div className={cx("bottom-sheet", closing ? "slide-down" : "slide-up")}>
        ...
        <div className="sheet-toggle">
          ...
          <button className={cx("toggle", pool && "toggle-on")} onClick={() => setPool((v) => !v)}>
            <span className="toggle-dot" />
          </button>
        </div>
  ...
  return (
    <div className="shell">
      ...
      <div className="phone">
        ...
        {showAdd && <CreateGoalOverlay onClose={() => setShowAdd(false)} onAdd={addGoal} />}
      </div>
    </div>
  );
}
